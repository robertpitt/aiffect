...
/**
 * Optional schema for a single conversation message for DB persistence.
 * Derive from pipeline events (e.g. TranscriptDelta with isFinal, ToolCallStarted, ToolCallCompleted).
 */
export class ConversationMessage extends Schema.TaggedClass<ConversationMessage>()(
  "ConversationMessage",
  {
